...
class FWP_Select2
{
    ...
    function init() {
        ...
        wp_enqueue_script( 'select2', $plugins_url . '/select2/select2.min.js', array( 'jquery' ), '4.0.0' );
        wp_enqueue_style( 'select2', $plugins_url . '/select2/select2.min.css', array(), '4.0.0' );
    }
